const CACHE_NAME = 'CuisineCompass-cache-v1'; // Update cache version
const urlsToCache = [
    'https://drkimogad.github.io/CuisineCompass/',
    'https://drkimogad.github.io/CuisineCompass/index.html',
    'https://drkimogad.github.io/CuisineCompass/styles.css',
    'https://drkimogad.github.io/CuisineCompass/script.js',
    'https://drkimogad.github.io/CuisineCompass/manifest.json',
    'https://drkimogad.github.io/CuisineCompass/icons/icon-192x192.png',
    'https://drkimogad.github.io/CuisineCompass/icons/icon-512x512.png',
    'https://drkimogad.github.io/CuisineCompass/favicon.ico',
    'https://drkimogad.github.io/CuisineCompass/offline.html' // Ensure offline page is cached
];
    ...
    event.respondWith(
        caches.match(event.request).then((cachedResponse) => {
            ...
            if (event.request.mode === 'navigate') {
                return caches.match('https://drkimogad.github.io/CuisineCompass/offline.html');  // Ensure offline.html is cached
            }
            ...
            return caches.match('https://drkimogad.github.io/CuisineCompass/offline.html');
        })
    );
});
